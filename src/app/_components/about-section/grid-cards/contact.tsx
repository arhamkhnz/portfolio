...
export default function Contact() {
  return (
    <>
      <div>
        <p className="text-primary text-red-500 text-xl tracking-tight lg:text-6xl">
      ...
      <div className="mt-8 flex w-full flex-col gap-2 sm:flex-row">
        ...
        <a
          ...
          target="_blank"
          className="flex h-12 flex-1 items-center justify-between rounded-lg bg-red-500 px-4 py-2 font-semibold text-sm text-white duration-200 hover:bg-white/5 hover:text-white"
          rel="noopener"
        >
          Drop Me an Email
