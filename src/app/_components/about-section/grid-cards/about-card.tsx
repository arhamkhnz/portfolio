...
export default function AboutCard() {
  return (
    <>
      <p className="font-medium text-3xl text-orange tracking-tight lg:text-4xl">Who Am I ?</p>
      <p className="mt-4 font-light text-sm text-white lg:text-lg">
        ...
        ,&nbsp;
        <StrikeThrough className="italic decoration-orange">E-Commerce</StrikeThrough> and&nbsp;
